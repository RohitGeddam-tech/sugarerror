...
const Statistics = loadable(() => import('../pages/Admin/Dashboard/Statistics/Statistics'));
const PathLabsList = loadable(() => import('../pages/Admin/PathLabs/List/PathLabsList'));
...
const parentUrl = '/assistant-admin';
